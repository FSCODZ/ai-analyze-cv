            ...
            <div className="space-y-8 animate-slide-in">
              ...
              <div className="space-y-6">
                <h1 className="text-5xl lg:text-6xl font-bold leading-tight">
                  Welcome to <span className="hero-gradient">CVision</span>
                </h1>
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                {isLoading ? (
                  <button className="hero-button px-8 py-4 text-lg animate-pulse">
                    Logging in...
                  </button>
                ) : auth.isAuthenticated ? (
                  <button className="hero-button px-8 py-4 text-lg" onClick={auth.signOut}>
                    Log Out
                  </button>
                ) : (
                  <button className="hero-button px-8 py-4 text-lg flex items-center gap-2" onClick={auth.signIn}>
                    Continue to Login
            ...
            <div className="relative animate-slide-in" style={{ animationDelay: '0.3s' }}>
              <div className="relative">
                <img 
                  ...
                  className="max-w-[80%] h-auto rounded-2xl shadow-elegant hover:shadow-glow transition-smooth mx-auto"
                />
              </div>
            </div>
